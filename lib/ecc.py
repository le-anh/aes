...
class ECC:
    ...
    def __init__(self) -> None:
        self.P = 115792089237316195423570985008687907853269984665640564039457584007908834671663  # P = 2^256 - 2^32 - 977
        self.A = 1
        self.B = 7
        ...
        self.N = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141  # order of E
    ...
    def Point_Multiplication(self, d, Q=''):
        if not Q: Q = self.G
        T = Point(Q.x, Q.y)
        for i in bin(d)[3:]:
